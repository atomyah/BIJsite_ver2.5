...
const BenzoWords = () => (
    <Layout>
      ...
      <li className={Style.liDeco}> 遷延性離脱症状 </li>
      ...
      <div style={{marginBottom: 20}}>
        ...
        和製用語であり、英語では「耐性形成による離脱症状（tolerance withdrawal）」と言います。
        耐性がつきベンゾジアゼピン薬がその効果を示しにくくなったとはいえ、まだいくらかでも興奮系神経伝達物質を抑制する効果が残っているのであれば、
        常用量離脱が発生してもテーパリング減薬していく必要があります。まったく効果を示さない、つまり服用していても中止してしまった場合と離脱症状の重症度が
        変わらないということになると、キンドリングに移行した、ということが言えます。
      </div> 
