...
このサイトは、なにも知らずに飲み続けている日本人730万人のベンゾジアゼピン系薬服用者の方のために、わたしの実体験にもとづいて作りました。まずはじめに強調しておきたいのは、よく知ればさほど怖いことにはなりません。<span className={Style.fontCrimson}>服薬していても絶対にすぐやめないように！</span>
      ...
      それらを世界的に集計しているのがINCB(国際麻薬統制委員会)。最新の2016年のデータをご紹介します。
        ...
        (<a href="https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/0000177221.html" target="blank" rel="noreferrer noopener">厚労省第二回NBDオープンデータ</a>より2mg＝1錠にて積算)。</p>
      ...
      おそらく<span className={Style.fontCrimson}>激しい離脱症状に見舞われる人々は服薬者の10%～30%程度</span>でしょう
      （それが医療現場でもほとんどのドクターが気づけなかった理由のひとつです）。<br />
      なぜ半数の人たちにとって長期服用が問題ないのか、薬理的には完全に解明されていません。
      しかし統計学的には諸説あるもののほぼ証明されています
      （マルコム・レーダー博士：‟<a href="https://www.benzo.org.uk/kwotez.htm" target="blank" rel="noreferrer noopener"><span className={Style.fontCrimson}>20~30%が離脱に苦労しそのうちの3割が激甚離脱症状を経験</span></a>"。
      アメリカ精神医学会：‟<a href="https://pubmed.ncbi.nlm.nih.gov/1987812/" target="blank" rel="noreferrer noopener">40%~80%が離脱症状を経験する</a>”。
      マイケル・ソヤカ博士：“<Link to="doctors-article/11"><span className={Style.fontCrimson}>1か月の連用で約半数が身体依存形成される</span></Link>”。）
      <br />
      <p></p>
      <Jumbotron>
      ...
      <p>器質的な異常が見つからないとどの医師も「安定剤（抗不安薬）を出しておこう」というわけです（また日本は睡眠不足大国でもあります）。
        ...
        最近では<strong>コロナウィルス</strong>感染後に残る、微熱が続くだとか倦怠感に対し処方する例が目立っています。
        ...
        ただしメイラックス（ロフラゼプ酸）など半減期が超長期のベンゾには注意で、それらについてはすべてのケースで数年の漸減が必要と思った方が良いでしょう）<br />
        <br />
        ※&nbsp;<strong>主治医のいうとおりのペース例&nbsp;</strong>＝ 「半分に割って数週，さらに4分の1で数週、そして0に」「減薬期間は約3か月で」など。
        <p><br />
        離脱症状が出た場合でも短期間で終わる可能性はそれなりにあります。しかし、自分は大丈夫だろうと甘くみないように。<span className={Style.fontCrimson}>ベンゾの場合は数ヶ月での断薬は一気断薬と同じ</span>と思ってください。
